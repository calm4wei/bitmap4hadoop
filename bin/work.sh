...
CONF_PATH=$RAZOR_BITMAP_HOME/conf:$HADOOP_CONF:$HBASE_CONF
CLASSPATH="$CONF_PATH:$RAZOR_BITMAP_HOME/lib/*:$HADOOP_CLASSPATH:$HBASE_CLASSPATH:$CLASSPATH"
LOG_PATH=$RAZOR_BITMAP_HOME/logs
RUN_PATH=$RAZOR_BITMAP_HOME/run
...
case $1 in
  ...
  t)
    ...
    ;;
  l)
    CLASS="com.cobub.bigdata.mr.LaunchStatistics"
    LOG_FILE="LaunchStatistics.out.$2"
    PID_FILE="LaunchStatistics.pid.$2"
    ;;
  *)
esac
